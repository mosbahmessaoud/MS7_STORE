...
@section('titel', 'Fruitkha - Slider Version')
@section('allprodcs')
                    ...
                    <div class="image">
                        <div class="price-box">
                            <div class="inner-price">
                                <span class="price">
                                    <strong>30%</strong> <br> off per one
                                </span>
                            </div>
                        </div>
                        {{-- <img src="assets/img/catigoies/phoff01.PNG" alt=""> --}}
                        <img src="assets/img/catigoies/phoff03.jpg" style="border-radius: 7px">
                    </div>
                </div>
                <!--Content Column-->
